            ...
            <ScrollView style={{flex: 1}}>
                ...
                <View style={styles.form}>
                    <View style={styles.avatarContainer}>
                        ...
                        <Pressable style={styles.camerIcon} onPress={onPickImage}>
                            <Icon name="camera" size={20} strokeWidth={2.5} />
                        </Pressable>
                    </View>
                    <Text style={{fontSize: getHeightPercentage(1.5), color: theme.colors.text}}>Please fill your profile details</Text>
                    ...
                    <Button title='Save' loading={loading} onPress={onSubmit}/>
                </View>
            </ScrollView>
        </View>
    </ScreenWrapper>
